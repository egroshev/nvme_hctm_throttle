...
# ==============================================================================
# Advanced SSD Thermal Management (TMT) Script (Legacy Compatible)
#
# Description:
# This script is designed to work with older versions of nvme-cli that do not
# support the JSON output format. It uses standard text parsing tools instead.
#
...
ID_CTRL_OUTPUT=$(nvme id-ctrl "$NVME_DEVICE")
if [ $? -ne 0 ]; then
